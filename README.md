...
You can use the [Web PPM Viewer](https://0xc0de.fr/webppm/).The ppm file are stored in the temp file. Because it's compiling with **/src/10_PositionableCamera_2.cpp**, you will see  
![](/doc/chapter10.png)
