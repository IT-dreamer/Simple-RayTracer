...
int main(void)
{
    ...
    vec3<float> lookfrom(3.0f, 3.0f, 2.0f);
    vec3<float> lookat(0.0f, 0.0f, -1.0f);
    ...
    list[2] = new sphere(vec3<float>(1.0f, 0.0f, -1.0f), 0.5f, new metal(vec3<float>(0.2f, 0.4f, 0.3f)));
